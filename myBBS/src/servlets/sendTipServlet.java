...
public class sendTipServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(!isSuccess){
			...
			RequestDispatcher rd=request.getRequestDispatcher("/sendTip.jsp");
			rd.forward(request, response);
		}else{
			Tip tip=new Tip(title,content,publishTime,id,1,tipPrivate);
			tdao.addTip(tip);
