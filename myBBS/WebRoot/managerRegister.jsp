<%@ page language="java" import="java.util.*" import="DAOs.UserDAO" pageEncoding="UTF-8" contentType="text/html;charset=UTF-8"%>
...
<html>
  ...
  <body background="images/register.jpg">
    ...
    boolean managerSet = udao.findManager();
    %>
    
    <%if(managerSet){%>
      <h3 align="center">管理员已存在！</h3><p>
      <h3 align="center"><a href="login.jsp">点击返回登陆界面</a></h3><p>
    <%}else{ %>
      ...
      <h1>用户注册</h1>
      <form  action="managerRegister.do" method="post" enctype="multipart/form-data">
