...
<html>
  ...
  <body style="background:#d1faff">
    ...
    <input type="button" value="返回" onClick="window.location.href='singleBoard.jsp?b_id=<%=b_id%>'" style="height:47px;position:absolute;left:15%;top:16%;width:121px;font-size:20px;background:#fcb0d9;border:none">
    ...
    <div style="position:absolute;left:15%;top:25%;">
      <form method="post" action="sendTipBoard.do">
        <table bordercolor="black" cellspacing="20" border="1" style="width:1320px;height:651px;table-layout:fixed">
          ...
          <tr><td colspan="2"><input style="display:none" type="text" name="b_id" value="<%=b_id%>"></td></tr>
        </table>
      </form>
    </div>
  </body>
